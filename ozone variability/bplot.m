...
if horizontalFlag
    ...
    text(y + 0.5,medianX-0.15,num2str(medianX)); % yahya
    if meanFlag
        hReg2(end+1) = plot(y,meanX,'+','linewidth',linewidth,'color',meanColor,'markersize',10);
        text(y + 0.5,meanX+0.15,num2str(meanX)); % yahya
    end
